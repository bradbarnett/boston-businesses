...
var map = new mapboxgl.Map({
    container: 'map',
    // style: 'mapbox://styles/bradrbarnett/cj4q30ruk6pbn2sl803b2796o',
    // style: 'mapbox://styles/bradrbarnett/cj4pyefvc1hgr2soy6a6fn8av',
...
function runViz(error, points) {
    ...
    pointData.forEach(function (d,i) {
        ...
        console.log(pointData[0].LngLat);
    ...
    function pointsUpdate() {
        ...
        circles.attr("cx", function (d) {
            var x = project(d.LngLat).x;
            return x
        });
        circles.attr("cy", function (d) {
            var y = project(d.LngLat).y;
            return y
        });
        // circles.attr("r", function (d) {
        //     if (d.properties.reviews > 10) {
